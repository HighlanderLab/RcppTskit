...
ts_load <- function(file, options = 0L) {
    .Call(`_RcppTskit_ts_load`, file, options)
}
...
ts_dump <- function(ts, file, options = 0L) {
    invisible(.Call(`_RcppTskit_ts_dump`, ts, file, options))
}
...
ts_metadata_length <- function(ts) {
    .Call(`_RcppTskit_ts_metadata_length`, ts)
}
